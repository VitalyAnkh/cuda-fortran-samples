...
integer(4), device, allocatable :: ipiv_d(:)
integer(4) :: istat
...
! Call LU routines
call startTimer()
call dgetrf(m,n,a_d,lda,ipiv_d,info)
call endTimer()
call dgetrs('n',n,nrhs,a_d,lda,ipiv_d,b_d,ldb,info)
